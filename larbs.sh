...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/ibarryuk/voidrice.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/ibarryuk/LARBS/master/progs.csv"
